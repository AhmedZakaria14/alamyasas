...
- [x] إضافة زر واتساب عائم مرتبط بالرقم +201033188096 في القالب المشترك لكل الصفحات.
- [x] إضافة زر اتصال عائم مرتبط بالرقم +201033188096 مع تسميات وصول عربية واضحة.
- [x] ضبط موضع الأزرار وحجمها على الهاتف وسطح المكتب، ثم إعادة البناء والتحقق والمزامنة إلى GitHub.
